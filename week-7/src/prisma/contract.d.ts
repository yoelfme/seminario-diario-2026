...
export type StorageHash =
  StorageHashBase<'ac5b77c67f4eb5b33f5bd0f8fdeedd532cd1a36276db27a086939870df323fdd'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Talk: {
      ...
      readonly speaker: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Talk: {
      ...
      readonly speaker: CodecTypes['pg/text@1']['input'];
...
> & {
  ...
  readonly roots: {
    readonly talk: { readonly namespace: 'public' & NamespaceId; readonly model: 'Talk' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
          ...
          readonly Talk: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly speaker: { readonly column: 'speaker' };
